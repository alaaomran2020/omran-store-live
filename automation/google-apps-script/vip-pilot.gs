...
const VIP_PILOT_SCHEMA_VERSION = '0.1.0-DRAFT';

const VIP_PILOT_SHEETS = {
  VIP_Customers: ['customer_id', 'phone_e164', 'display_name', 'consent_version', 'consent_at', 'status', 'created_at', 'updated_at'],
  VIP_Memberships: ['membership_id', 'customer_id', 'program_code', 'status', 'started_at', 'ends_at', 'created_at', 'updated_at'],
  ...
  VIP_Cards: ['card_id', 'membership_id', 'card_type_id', 'serial_number', 'verification_token_hash', 'status', 'issued_at', 'activated_at', 'expires_at', 'replaced_by_card_id', 'created_by'],
  ...
  VIP_Offers: ['offer_id', 'provider_type', 'provider_id', 'display_name_ar', 'discount_kind', 'discount_value', 'maximum_discount_piasters', 'minimum_invoice_piasters', 'usage_limit_per_card', 'starts_at', 'ends_at', 'total_budget_piasters', 'funding_owner', 'stackable', 'status', 'approval_id'],
  ...
  VIP_Points_Ledger: ['points_entry_id', 'customer_id', 'reference_id', 'entry_kind', 'points', 'state', 'created_at', 'available_at', 'expires_at', 'reversal_of_entry_id', 'recorded_by', 'approval_id'],
  ...
  VIP_Staff_Roles: ['staff_identity', 'role_code', 'branch_scope', 'status', 'approved_by', 'approved_at'],
  VIP_Audit_Log: ['audit_id', 'event_id', 'actor_identity', 'action', 'entity_type', 'entity_id', 'before_digest', 'after_digest', 'occurred_at'],
