...
export const HOME_TITLE = "عمران تويز | لعب أطفال وهدايا - شركة عمران التجارية";
export const HOME_DESCRIPTION =
  "عمران تويز من شركة عمران التجارية — لعب أطفال وهدايا. شوف المنتجات والتفاصيل واستفسر مباشرة على واتساب عن السعر والتوفر.";
