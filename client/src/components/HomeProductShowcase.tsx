    ...
    <section id="featured-products" className="scroll-mt-28 border-b border-brand-border bg-brand-cream py-8 sm:py-11" aria-labelledby="featured-products-title">
      <div className="container">
        <div className="flex items-end justify-between gap-3">
          <div>
            <p className="text-xs font-extrabold text-brand-blue sm:text-sm">ابدأ من المنتج نفسه</p>
            <h2 id="featured-products-title" className="mt-1 text-2xl font-black text-brand-navy sm:text-3xl">منتجات من عمران تويز</h2>
          </div>
        ...
        {productsQuery.isLoading ? (
          <div className="mt-5 grid grid-cols-1 gap-3 min-[360px]:grid-cols-2 sm:mt-6 sm:grid-cols-3 sm:gap-5 lg:grid-cols-4">
