    ...
    <section className="border-b border-brand-border bg-white py-3 sm:py-4">
      <div className="container">
        <a
          ...
          aria-label="افتح قسم بوب أب للهدايا والبالونات ومستلزمات الحفلات"
        >
            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/10 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.14em] text-[#ffd85d] backdrop-blur sm:text-[11px]">
                  <Sparkles size={12} aria-hidden="true" /> قسم الهدايا والبالونات
                </span>
                <div className="flex items-baseline gap-2">
                  ...
                  <p className="text-2xl font-black tracking-[-0.04em] text-white drop-shadow sm:text-3xl">بوب أب</p>
                  <span className="text-xs font-extrabold text-[#ffd85d] sm:text-sm">هدايا وبالونات</span>
                </div>
              </div>
