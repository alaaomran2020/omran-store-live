...
export default function BrandHeader() {
  ...
  return (
    <header className="relative z-40 border-b border-brand-border/80 bg-brand-surface/95 pt-[env(safe-area-inset-top)] shadow-[0_8px_30px_rgba(15,23,42,0.06)] backdrop-blur-xl">
