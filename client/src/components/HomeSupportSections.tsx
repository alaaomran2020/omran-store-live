    ...
    <>
      <section id="b2b" className="scroll-mt-28 border-b border-brand-border bg-white py-8 sm:py-11" aria-labelledby="b2b-title">
        <div className="container">
          <div className="grid gap-4 rounded-[2rem] border border-brand-blue/15 bg-[linear-gradient(135deg,#123b6d_0%,#1769e0_100%)] p-5 text-white shadow-[0_18px_50px_rgba(18,59,109,.16)] sm:p-7 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-xs font-black text-white/90"><BriefcaseBusiness size={15} aria-hidden="true" /> للجملة وB2B</span>
              <h2 id="b2b-title" className="mt-3 text-2xl font-black sm:text-3xl">صاحب محل؟ بتبيع أونلاين؟</h2>
              <p className="mt-2 max-w-2xl text-sm font-bold leading-7 text-white/80 sm:text-base">ابدأ من الكتالوج، اختار المنتجات اللي تهمك، وابعت الاستفسار بالكود عشان نراجع معاك السعر والكميات المتاحة.</p>
            </div>
            {b2bUrl && (
              <a href={b2bUrl} target="_blank" rel="noreferrer" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl bg-whatsapp px-5 py-3 text-sm font-black text-white shadow-lg hover:bg-whatsapp-hover">
      ...
      <section className="border-b border-brand-border bg-brand-cream py-8 sm:py-11" aria-labelledby="why-omran-title">
        <div className="container">
          <div className="text-center">
            <p className="text-xs font-extrabold text-brand-blue sm:text-sm">ليه عمران تويز؟</p>
          ...
          <div className="mx-auto mt-6 grid max-w-5xl gap-3 md:grid-cols-3">
            {TRUST_ITEMS.map(({ icon: Icon, title, description }) => (
              <article key={title} className="rounded-[1.5rem] border border-brand-border bg-white p-5 shadow-sm">
      ...
      <section className="border-b border-brand-border bg-white py-8 sm:py-11" aria-labelledby="faq-title">
        <div className="container grid gap-7 lg:grid-cols-[.8fr_1.2fr] lg:items-start">
          <div>
            <p className="text-xs font-extrabold text-brand-blue sm:text-sm">أسئلة سريعة</p>
      ...
      <section id="branches" className="scroll-mt-28 border-b border-brand-border bg-brand-cream py-8 sm:py-11" aria-labelledby="branches-title">
        <div className="container">
          <div className="flex items-end justify-between gap-3">
            <div>
              <p className="text-xs font-extrabold text-brand-blue sm:text-sm">فروعنا في طنطا</p>
          ...
          <div className="mt-5 grid gap-3 md:grid-cols-2">
            <article className="rounded-[1.5rem] border border-brand-blue/20 bg-white p-5 shadow-sm">
            ...
            <article className="rounded-[1.5rem] border border-brand-border bg-white p-5 shadow-sm">
