...
const published = (product: PopupProductInput): Product => ({
  ...
  qaStatus: "PASS",
  processedImage: product.localImage,
  reviewReason: null,
});
...
export const POPUP_PRODUCTS_SNAPSHOT: Product[] = [
  published({
    ...
    localImage: "/products/popup/pop-bal-us-100-catalog-v2.webp",
    sortOrder: 1001,
    rowIndex: 1001,
  }),
  published({
    ...
    localImage: "/products/popup/pop-bal-met-050-catalog-v2.webp",
    sortOrder: 1002,
    rowIndex: 1002,
  }),
  published({
    ...
    localImage: "/products/popup/pop-bal-panda-100-catalog-v2.webp",
    sortOrder: 1003,
    rowIndex: 1003,
  }),
  published({
    ...
    localImage: "/products/popup/pop-bal-met-100-catalog-v2.webp",
    sortOrder: 1004,
    rowIndex: 1004,
  }),
  published({
    ...
    localImage: "/products/popup/pop-bal-chr-050-catalog-v2.webp",
    sortOrder: 1005,
    rowIndex: 1005,
  }),
];
