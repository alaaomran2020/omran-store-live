        ...
        <Card>
          ...
          <div className="p-5">
            <EmptyState
              ...
              description="تسجيلات المشتركين الحالية لها مسار مستقل، وحسابات الموبايل + OTP تحتاج Runtime موثوقًا (راجع الإعدادات/الوثيقة المعمارية). عند تفعيل إجراء القراءة customers على البوابة يظهر الدليل هنا تلقائيًا — لا تُعرض أي بيانات مقدّرة."
            />
          </div>
        </Card>
      ) : (
